    ...
    startUpdatingData(){
        setInterval(() => {
            ...
            .then(d => {
                ...
                if(this.chartRef.feedData("&label=" + x_axis + "&value=" + y_axis)==='undefined')
        ...
        <div className="row mt-5 mt-xs-4">
            <div className="col-6 mb-3">
                 <div className="card-deck custom-card-deck">
                     Exchange A
                    <PriceCard header="Bitcoin(BTC)"  alt="fireSpot" label="(Price in USD)"   value={this.state.btcusd} />
                    <Recommendation value={this.state.btcusd}/>
                    <PriceCard header="Ethereum(ETH)"  alt="fireSpot" label="(Price in USD)"    value={this.state.ethusd}/>
                    <Recommendation value={this.state.ethusd}/>
                 </div>          
            </div>
